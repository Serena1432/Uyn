...
module.exports.run = async (client, message, args, language) => {
    ...
    if (message.mentions.users.size) {
        ...
        var gif = "";
        request(
            "https://api.tenor.com/v1/search?q=anime kill&key=" + process.env.tenor_api_key + "&limit=40",
            function(error, response, body) {
                ...
                if (response && response.statusCode == 200) {
                    ...
                    const image = {
                        ...
                        author: {
                            name: message.author.username + language.kill + message.mentions.users.first().username + '\n' + text,
