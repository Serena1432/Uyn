...
module.exports.run = async (client, message, args, language) => {
    ...
    if (!args.length) {
        ...
        fields.push({
            ...
            value: "[Invite Link](https://discord.com/oauth2/authorize?client_id=" + client.user.id + "&scope=bot&permissions=271707254) | [Support Server](https://discord.gg/xjS8djsNDz) | [Vote this BOT](https://top.gg/bot/" + client.user.id + "/vote) | [Source Code](https://www.github.com/LilShieru/Uyn)",
            inline: false
        });
        for (i = 0; i < categories.length; i++) {
            var commandList = [];
